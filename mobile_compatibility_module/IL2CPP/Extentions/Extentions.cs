...
using TaskScheduler = Il2CppSystem.Threading.Tasks.TaskScheduler;
using TaskSchedulerException = Il2CppSystem.Threading.Tasks.TaskSchedulerException;
...
public static partial class Extentions
{
    ...
    public static Object LoadAsset(this AssetBundle bundle, string name, Type type)
    {
        return bundle.LoadAsset(name, type.C());
    }
    public static Object[] LoadAllAssets(this AssetBundle bundle, Type type)
    {
        return bundle.LoadAllAssets(type.C());
    }
